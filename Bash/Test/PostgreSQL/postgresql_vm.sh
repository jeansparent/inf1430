...
echo "Max CPU usage for PostgreSQL: $cpu_max %"
echo "Mean CPU usage for PostgreSQL: $cpu_mean %"
echo "Max MEM (RSS) for PostgreSQL: $mem_max KB"
echo "Mean MEM (RSS) for PostgreSQL: $mem_mean KB"
echo "============================================="
