...
# Déploiement du Terraform pour Applicatif
terraform -chdir=$SCRIPTPATH/Docker init
terraform -chdir=$SCRIPTPATH/Docker plan -out applicatif-docker.plan
terraform -chdir=$SCRIPTPATH/Docker apply "applicatif-docker.plan"