...
resource "azurerm_network_security_rule" "nsg_dev-vm_http_8080" {
  name                        = "HTTP"
  priority                    = 200
  direction                   = "Inbound"
  access                      = "Allow"
...
resource "azurerm_network_security_rule" "nsg_dev-vm_iperf" {
  name                        = "IPERF3"
  priority                    = 300
  direction                   = "Inbound"
  access                      = "Allow"
...
resource "azurerm_network_security_rule" "nsg_dev-vm_postgres" {
  name                        = "POSTGRES"
  priority                    = 500
  direction                   = "Inbound"
  access                      = "Allow"
